...
def downgrade() -> None:
    if _index_exists("auth_tokens", "ix_auth_tokens_expires_at"):
        op.drop_index("ix_auth_tokens_expires_at", table_name="auth_tokens")

    if _index_exists("auth_tokens", "ix_auth_tokens_token_type"):
        op.drop_index("ix_auth_tokens_token_type", table_name="auth_tokens")

    if _index_exists("auth_tokens", "ix_auth_tokens_token_hash"):
        op.drop_index("ix_auth_tokens_token_hash", table_name="auth_tokens")

    if _index_exists("auth_tokens", "ix_auth_tokens_user_id"):
