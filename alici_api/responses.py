...
class Codes:
    ...
    JOB_QUEUED_OK = "OK-JOB-202"
    JOB_STATUS_OK = "OK-JOB-200"
    BILLING_CHECKOUT_OK = "OK-BILLING-CHK-200"
    BILLING_PORTAL_OK = "OK-BILLING-PORTAL-200"
    BILLING_PLANS_OK = "OK-BILLING-PLANS-200"

    BAD_REQUEST = "ERR-REQ-400"
    PROMPT_BLOCKED = "ERR-AI-PROMPT-400"
    UNAUTHORIZED = "ERR-AUTH-401"
    FORBIDDEN = "ERR-AUTH-403"
    PAYMENT_REQUIRED = "ERR-CREDITS-402"
