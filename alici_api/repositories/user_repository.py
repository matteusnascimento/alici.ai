...
from database import atualizar_usuario, buscar_usuario_por_email, buscar_usuario_por_id, criar_usuario
...
class UserRepository:
    ...
    def update(self, user_id: int, **campos):
        return atualizar_usuario(user_id, **campos)
