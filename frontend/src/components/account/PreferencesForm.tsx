  ...
  <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
    <div className="flex flex-wrap items-start justify-between gap-4">
      ...
      <select
        ...
        className="min-w-[210px] rounded-lg border border-white/10 bg-ink/60 px-3 py-2.5 text-sm text-white outline-none transition hover:border-white/20 focus:border-cyan/60"
      >
        {options.map((opt) => (
