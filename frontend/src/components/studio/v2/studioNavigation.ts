...
export const studioNavItems: StudioNavItem[] = [
  ...
  { key: 'captions', label: 'Legendas Automaticas', route: '/app/studio/legendas', section: 'content' },
  { key: 'ad-copy', label: 'Copy para Anuncio', route: '/app/studio/legendas', section: 'content' },
  { key: 'cta', label: 'CTA Generator', route: '/app/studio/legendas', section: 'content' },
  { key: 'headlines', label: 'Headlines', route: '/app/studio/legendas', section: 'content' },
  { key: 'descricao', label: 'Descricao de Produto', route: '/app/studio/legendas', section: 'content' },
  { key: 'roteiro', label: 'Roteiro de Video', route: '/app/studio/video-editor', section: 'content' },
  { key: 'brand-kit', label: 'Brand Kit', route: '/app/studio/templates', section: 'brand' },
  { key: 'logos', label: 'Logos', route: '/app/studio/assets', section: 'brand' },
  { key: 'paletas', label: 'Paletas', route: '/app/studio/templates', section: 'brand' },
  ...
  { key: 'campanhas', label: 'Campanhas', route: '/app/studio/projects', section: 'projects' },
  { key: 'exportados', label: 'Exportados', route: '/app/studio/projects', section: 'projects' },
