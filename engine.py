    ...
    try:
        response = asyncio.run(
            AIManager().chat(
                pergunta,
                (
                    "Voce e a ALICI, uma IA proprietaria de alto nivel. "
                    "Responda com clareza, didatica, simpatia e tom profissional."
                ),
            )
        )
        ...
        logger_engine.error(f"Erro na camada central de IA: {e}")
        return None
